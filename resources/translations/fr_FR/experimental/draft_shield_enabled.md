Activer le bouclier
====
Lorsque ce paramètre est activé, l'imprimante construit autour de votre impression une enveloppe (un paravent) qui la protège des courants d'air provenant de l'environnement.
...
* Le paravent peut être doublé en tant que [bouclier anti-suintage](../dual/ooze_shield_enabled.md). Si les déplacements se font vers un objet protégé par un paravent, tout suintement restant sur la buse sera essuyé sur le paravent.
